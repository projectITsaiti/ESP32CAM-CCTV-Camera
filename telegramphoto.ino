...
String BOTtoken = "5845332798:AAEGhORrvdL0c2_bVEByUZcvpzNBkQovlQs"; // isi dengan token dari botfather tele
String chatId = "1281826083"; //isi dengan id chat dari id bot
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    if (text == "/start"){
      ...
      welcome += "Gunakan Bot ESP32CAM Project TA Saiti ini untuk berinteraksi dengan Sistem Keamanan ini.\n";
      welcome += "klik tulisan biru 👇\n";
      welcome += "/foto  : untuk ambil gambar langsung\n";
      welcome += "/flash : untuk on off lampu flash\n";
      welcome += "/start : untuk memulai sistem\n";
      welcome += "sistem ini akan otomatis mengirim foto saat terjadi gerakan.\n";
